                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="frist_name">Pertanyaan</label>
                        <input id="frist_name"
                            type="text"
                    ...
                    <div class="form-group">
                     <label>Jawaban A</label>
                      <div class="input-group">
                        ...
                        <div class="input-group">
                            <input  type="text" class="form-control @error('jawaban_b') is-invalid
                            @enderror"
                            name="jawaban_b">
                        </div>
                        @error('jawaban_b')
                        ...
                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                            <input type="text"  class="form-control @error('jawaban_c') is-invalid
                            ...
                            <div class="invalid-feedback">{{ $message }}</div>
                             @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input  type="text"  class="form-control @error('jawaban_d') is-invalid
                            @enderror"
                            name="jawaban_d">
                                    </div>
                                    @error('jawaban_d')
